...
#Grab CSRFTOKEN
curl -s 'https://account.withings.com/connectionuser/account_login?appname=my2&appliver=df77ca8f&r=https%3A%2F%2Fhealthmate.withings.com%2F' > csrf.txt
CSRFTOKEN=$( grep csrf csrf.txt | awk -F'"' '$0=$6')
#Authenticate
